...
class ClassTypeCreator22<T> {
    ...
    public static void main(String[] args) {
        ...
        try {
            Building1 b = (Building1) ctcb.createNew("generics.Building1");
            ...
            House1 h = (House1) ctch.createNew("generics.House1", "Hawaii");
            House1 h2 = (House1) ctch.createNew("generics.House1", 3000);
            House1 h3 = (House1) ctch.createNew("generics.House1", "Manila", 5000);
